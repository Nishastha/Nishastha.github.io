...
class PageTemplates {
                ...
                <div class="container">
                    <div class="nav-container">
                        ...
                        <nav class="main-nav">
                            ...
                            <ul>
                                <li><a href="index.html" class="${isActive('index.html')}"><i class="fas fa-home"></i> Home</a></li>
                                <li><a href="about.html" class="${isActive('about.html')}"><i class="fas fa-info-circle"></i> About</a></li>
                                <li class="dropdown ${isDropdownActive(['courses.html', 'facilities.html'])}">
                                    <a href="#" class="dropdown-toggle"><i class="fas fa-graduation-cap"></i> Academics</a>
                                    <div class="dropdown-menu">
                                        <a href="courses.html" class="${isActive('courses.html')}">Courses</a>
                                        <a href="facilities.html" class="${isActive('facilities.html')}">Facilities</a>
                                    </div>
                                </li>
                                <li class="dropdown ${isDropdownActive(['news.html', 'blog.html', 'events-and-gallery.html'])}">
                                    <a href="#" class="dropdown-toggle"><i class="fas fa-users"></i> Community</a>
                                    <div class="dropdown-menu">
                                        <a href="news.html" class="${isActive('news.html')}">News & Notices</a>
                                        <a href="blog.html" class="${isActive('blog.html')}">Blog</a>
                                        <a href="events-and-gallery.html" class="${isActive('events-and-gallery.html')}">Events</a>
                                    </div>
                                </li>
                                <li><a href="contact.html" class="${isActive('contact.html')}"><i class="fas fa-phone"></i> Contact</a></li>
                                <li><a href="login.html" class="login-btn ${isActive('login.html')}"><i class="fas fa-sign-in-alt"></i> Login</a></li>
                                <li><a href="admission.html" class="admission-btn ${isActive('admission.html')}"><i class="fas fa-user-plus"></i> Admission Open</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
        ...
        return `
            <footer>
                <div class="footer-content">
                    ...
                    <div class="footer-section">
                        <h3><i class="fas fa-users"></i> Student Portal</h3>
                        <ul>
                            <li><a href="login.html"><i class="fas fa-sign-in-alt"></i> Student Login</a></li>
                            <li><a href="#"><i class="fas fa-clipboard-list"></i> Assignments</a></li>
                            <li><a href="#"><i class="fas fa-calendar-check"></i> Schedule</a></li>
    ...
    static initializeNavigation() {
        ...
        console.log('Initializing navigation...', { mobileMenuToggle, mainNav, mobileOverlay });
        ...
        if (mobileMenuToggle && mainNav) {
            ...
            console.error('Mobile menu elements not found:', { mobileMenuToggle, mainNav, mobileOverlay });
        }
